...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Exploring the cutting-edge technologies and methodologies that will shape web development in the coming year.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Learn how to create inclusive web experiences that work for everyone, regardless of their abilities or disabilities.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Deep dive into advanced techniques for optimizing React applications and delivering lightning-fast user experiences.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "A practical comparison of CSS Grid and Flexbox to help you choose the best layout solution for your projects.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Essential patterns and practices for maintaining type safety and code quality in enterprise TypeScript projects.",
    content: `
